...
<body>
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="height: 50px; font-weight: bold;">
 <a class="navbar-brand" href="index.php" style="font-family: 'Noto Sans JP',sans-serif; height: 40px;"><img src="https://image.flaticon.com/icons/svg/2760/2760147.svg" alt="Coronavirus free icon" title="Coronavirus free icon" style="width: 30px; height: 30px;"> Corona Tracker</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-left: 300px;" >
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="index.php">World Overview</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="india.php">India Overview<span class="sr-only">(current)</span></a>
      </li>
    </ul>
  </div>
</nav>
